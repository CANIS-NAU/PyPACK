...
def heatmap(loc_gdf, column="Location Extracted", normalize_data=False, output_name='heatmap.html', output_dir=''):
    '''
    Given a Geopandas DataFrame this will generate a Heatmap with the Python package folium.

    Parameters
    ----------
    loc_gdf: Pandas DataFrame
    ...
    normalize_data: boolean
            An option whether or not to normalize the data.

    output_name: str
            The name of the HTML file which will contain the HeatMap.

    output_dir: str
            The directory in which to output the HTML file, which can be viewed.

    Returns
    -------
    : folium heatmap
      A map generated by Folium.
